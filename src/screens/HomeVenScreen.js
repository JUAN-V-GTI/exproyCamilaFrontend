      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={() => setShowDropdown(!showDropdown)}>
            <View style={styles.avatar}>
              <Icon name="account-circle" size={30} color="#fbe56f" />
            </View>
          </TouchableOpacity>
        </View>
        ...
        {showDropdown && (
          <View style={styles.dropdown}>
            ...
            <View style={styles.dropdownItem}>
              ...
              <Text style={styles.dropdownText}>Rol: Vendedor</Text>
            </View>
        ...
        <ScrollView>
          ...
          <TouchableOpacity style={styles.button} onPress={handleInventario}>
            ...
            <TouchableOpacity style={styles.button} onPress={VentasScreen}>
              <View style={styles.imageContainer}>
